...
namespace Criteo.OpenApiDiff.Core
{
    /// <summary>
    ...
    public class Settings
    {
        ...
        /// <summary>
        ///The location of the old specification.
        /// </summary>
        ...
        /// <summary>
        /// The location of the new specification.
        /// </summary>
        ...
        /// <summary>
        /// The version of the compared OAS. The differentiation rules can differ according to.
        /// </summary>
        [SettingsAlias("version")]
        public OpenApiSpecVersion Version { get; set; } = OpenApiSpecVersion.OpenApi2_0;
        ...
        private static Dictionary<string, object> ParseArgs(string[] arguments)
        {
            ...
            if (arguments != null && arguments.Length > 0)
            {
                ...
                {
                    var argument = arg?.Trim() ?? string.Empty;
        ...
        private static void PopulateSettings(object entityToPopulate, IDictionary<string, object> settings)
        {
            ...
            if (settings != null && settings.Count > 0)
            {
                ...
                {
                    PropertyInfo property = entityToPopulate.GetType().GetProperties().FirstOrDefault(p =>
                        setting.Key.Equals(p.Name, StringComparison.OrdinalIgnoreCase) || p
                            .GetCustomAttributes<SettingsAliasAttribute>().Any(a =>
                                setting.Key.Equals(a.Alias, StringComparison.OrdinalIgnoreCase)));
                    ...
                    if (property != null)
                    {
                        try
                        {
                            ...
                            else if (property.PropertyType.IsArray && setting.Value.GetType() == typeof(JArray))
                            {
                                ...
                                {
                                    var stringArray = ((JArray) setting.Value).Children().Select(c => c.ToString())
                                        .ToArray();
                        ...
                        catch (Exception exception)
                        {
                            throw new ArgumentException(
                                string.Format(CultureInfo.InvariantCulture, Resources.ParameterValueIsNotValid,
        ...
        /// <param name="arguments">Command line arguments</param>
        /// <returns>An instance of Settings object</returns>
        ...
        /// </summary>
        /// <exception cref="Exception">Parameter value is missing</exception>
        public void Validate()
        {
            foreach (PropertyInfo property in (typeof(Settings)).GetProperties())
            {
                ...
                if (property.GetValue(this) == null && doc != null && doc.IsRequired)
                {
            ...
            if (!File.Exists(_instance.OldSpec))
            {
                throw new Exception(string.Format(Resources.InputMustBeAFile, "-old"));
            }

            if (!File.Exists(_instance.NewSpec))
            {
